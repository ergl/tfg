...
\begin{itemize}
    ...
    \item Delimit project scope. After having the necessary knowledge to carry out the work, we established the limits and specific contributions of the work. We also establish the hypotheses that the final implementation should validate.
    ...
    \item Benchmark and validation. With the implementation complete, we design representative benchmarks and scenarios to validate the performance of the implementation. We also validate previous hypotheses, and frame the results in the context of the existing literature.
\end{itemize}
