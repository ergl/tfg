...
* Mention that our read protocol is from GMU, but that they provide Update-SER
...
Mention Blotter, Walter etc for approaches via replication

Talk about Blotters's TTL GC?
}
