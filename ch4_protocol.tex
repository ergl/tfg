...
\todo{Figure what to do with the example}

\todo{
  \begin{itemize}
    \item Think if \emph{causal dependency} is already defined in a previous section
    \item Mention that we disallow blind updates (should be done in the specification)
  \end{itemize}
}
