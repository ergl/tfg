...
\todo{Write some words here, describe the most important changes. Consider highlighting the changes.}
...
\begin{tabularx}{\linewidth}{|c|p{6.5cm}|X|}
  ...
  \hline
  $T.\RS$ & ${\sf Set}[\langle \keytype, {\sf Integer}\rangle]$ & Read-set of $T$. \\
  \hline
  $T.\WS$ & ${\sf Set}[\langle \keytype, \valuetype \rangle]$ & Write-set of $T$. \\
  \hline
...
\caption{List of variables used in the Serialisable protocol.}
