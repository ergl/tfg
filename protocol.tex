...
Each server $s_i$ maintains five main data structures, summarised in Figure~\ref{fig:prot-ds-table}. We now offer a more detailed explanation of each of them.
